...
import com.khnkoyan.userimagesapplication.viewHolders.ImageListWithCheckboxHolder;

import java.util.ArrayList;
import java.util.List;

public class ImageListAdapterWithCheckbox extends RecyclerView.Adapter<ImageListWithCheckboxHolder> {
    private Context context;
    private List<Image> imageList;
    private boolean isSelectedAll;
    private boolean isClick= true;

    public ImageListAdapterWithCheckbox(Context context, List<Image> imageList) {
        this.context = context;
        this.imageList = imageList;
    }

    @Override
    public ImageListWithCheckboxHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.image_item_with_checkbox, viewGroup, false);
        return new ImageListWithCheckboxHolder(view);
    }

    @Override
    public void onBindViewHolder(final ImageListWithCheckboxHolder holder, final int position) {
